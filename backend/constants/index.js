...
export const highlightsProducts = [
  ...
  },
  {
    ...
    _base: '/products/?active=cellPhones',
    color: '#ffffff',
  },
  {
    _id: 3003,
...
export const products = [
  ...
  },
  {
    ...
    images: [
      'https://i.ibb.co/WNBLqhP7/1330839446.webp',
      'https://i.ibb.co/m6ZN7LX/soundBox.webp',
      'https://i.ibb.co/wdV3b9q/vaccum.webp',
      'https://i.ibb.co/tcdSfrr/blueGun.jpg',
      'https://i.ibb.co/pw0fGmx/gaming-Controller.webp',
  ...
  {
    _id: 2005,
    name: 'Redmi Xiaomi Speaker Play 2.4GHz 1.75 Inch Voice Remote Control Music Player Bluetooth 4.2 Mi Speaker For Android Iphone',
    images: [
